    ...
    <header className="fixed w-full bg-slate-950/95 backdrop-blur-md shadow-lg z-50 border-b border-slate-800">
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <a
            href="#home"
            className="relative py-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 group font-medium"
          >
            Início
        ...
        <div className="flex items-center gap-4 md:hidden">
          {/* Mobile Menu Button */}
          <button
            className="text-2xl text-cyan-400 p-2 rounded-lg hover:bg-slate-800 transition-all duration-200 hover:scale-110"
            onClick={() => setOpen(!open)}
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute top-16 left-0 w-full bg-slate-950/95 backdrop-blur-md border-b border-slate-800 md:hidden transition-all duration-300 overflow-hidden ${
            open ? 'max-h-80 opacity-100' : 'max-h-0 opacity-0'
          }`}
        >
          <div className="flex flex-col items-center gap-2 py-6">
            <a
              onClick={() => setOpen(false)}
              href="#home"
              className="w-full text-center py-3 px-6 text-gray-300 hover:text-cyan-400 hover:bg-slate-900/50 transition-all duration-200 font-medium"
            >
              Início
            </a>
            <a
